...
contains
  ...
  function doublePrecisionEqual (number1, number2 ) result (resultValue)
    Real (DBprec) , intent (in) :: number1, number2
    real :: epsilon
    logical :: resultValue
...
999 continue
  ...
  subroutine assert_eq_double_(var1, var2, message)
    ...
    Real (DBprec), intent (in) :: var1, var2
  ...
  subroutine assert_eq_double_in_range_not_value_(var1, var2, delta, tval, message)
    ...
    Real (DBprec), intent (in) :: var1, var2, tval
    Real (DBprec), intent (in) :: delta
    character(len = *), intent (in), optional :: message
  ...
  subroutine assert_eq_1d_double_(var1, var2, n, message)
    integer, intent (in) :: n
    integer              :: i
    Real (DBprec), intent (in) :: var1(n), var2(n)
  ...
  subroutine assert_eq_2d_double_(var1, var2, n, m, message)
    integer, intent (in) :: n, m
    integer              :: i, j
    Real (DBprec), intent (in) :: var1(n, m), var2(n, m)
